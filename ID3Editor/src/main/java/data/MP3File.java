...
import toolbox.BitOppereations;
import xml.ByteArrayMarshallerAdapter;
import data.tag.MP3TagFrame;
import data.tag.PictureFrame;
import data.tag.TextFrame;
...
public class MP3File extends MP3Object {
	...
	public void createTag(byte[] tagHeader) {
		...
		unsynchronisation = toolbox.BitOppereations.testBit(tagHeader[5], 0);
		extendedHeader = toolbox.BitOppereations.testBit(tagHeader[5], 1);
		experimentalIndicator = toolbox.BitOppereations
	...
	public byte[] getBytes() {
		...
		tagSize = toolbox.ByteOpperations
