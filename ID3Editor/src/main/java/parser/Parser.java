...
public class Parser {
	...
	public static int getTagSize(byte[] tagHeader) throws Exception {
		...
		return toolbox.ByteOpperations.convertSynchsafeByteToInt(sizeArray);
	}
	...
	private static int getFrameSize(byte[] frameHeader) throws IOException {
		...
		return toolbox.ByteOpperations.convertByteToInt(sizeArray);
	}
